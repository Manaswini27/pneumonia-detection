...
model.save('/content/drive/My Drive/finalmodel.keras')
#final keras equation -
#output = sigmoid( W2 * relu(W1 * flatten(CNN_layers(input)) + b1) + b2)

from tensorflow.keras.models import load_model
model = load_model('/content/drive/My Drive/models/finalmodel.keras')
...
if y_test.shape[0] != predictions.shape[0]:
    raise ValueError("y_test and predictions must have the same number of elements.")
...
image_path = '/content/drive/My Drive/test4n.jpeg'
